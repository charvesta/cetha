...
export function showToast(options: ToastOptions): boolean {
  ...
  toast.className = 'pointer-events-auto rounded-cetha-md border border-cetha-line bg-cetha-raised px-4 py-3 text-cetha-text shadow-cetha-md transition-[opacity,transform]';
